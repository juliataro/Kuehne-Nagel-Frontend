...
function createData(orderNo, date, customer, trackingNo, status, consignee, editData,) {
     
  return {
     orderNo, date, customer, trackingNo, status, consignee, editData,
  };
}

const rows = [
  createData("nz-906145-26850629-1813784",
  "7/10/2019",
  "Inter Parfums, Inc.",
  "TP-065338-70937481-7664135",
  "'Delivered'",
  "Hovnanian Enterprises Inc"),
  createData("nz-906145-26850629-aaaaaa",
  "7/10/2019",
  "Inter Parfums, Inc.",
  "TP-065338-70937481-7664135",
  "'Delivered'",
...
function EnhancedTableToolbar(props) {
  ...
  return (
    ...
    >
      {numSelected > 0 ? (
        <Typography
          sx={{ flex: '1 1 100%', marginTop:'5em', marginBottom:'1em' }}
          color="inherit"
          variant="subtitle1"
          component="div"
        >
...
function handleDelete(orderNo){
  alert(`Button is clicked for row with order number ${orderNo}`)
}
...
export default function EnhancedTable() {
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelected = rows.map((n) => n.orderNo);
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell align="left">
                         <Button variant="contained" startIcon={<AssignmentIndIcon/>}></Button>
                         <Button 
